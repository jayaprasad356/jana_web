...
define('DOMAIN_URL', 'http://192.168.43.168/jana/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_jana";  // Change as required
    private $db_pass = "Jana@2022";  // Change as required
    private $db_name = "u743445510_jana";    // Change as required
